...
class ColdStartMovieSelector:
    ...
    def __init__(self, 
                 ...
                 min_vote_count=3000,  # 100개를 뽑아야 하므로 기준 완화
                 num_clusters=10,  # 클러스터 개수
                 movies_per_cluster=10,  # 클러스터당 영화 수
                 min_tag_relevance=0.15):  # 태그 관련도 기준 상향
        ...
        self.total_target = num_clusters * movies_per_cluster  # 100개
