"""
조건: 클러스터링 먼저(전체 데이터) -> 그 후 필터링(평점 3.6이하), 인기순 고려, 2010-2019, 태그 관련도 0.8
"""
...
class ColdStartMovieSelector:
    def __init__(self, 
                 ...
                 output_path='/home/ubuntu/ai-model/clustering/tag_movie/12-11/results/cluster_first/v5',
                 # --- 설정 ---
        ...
        print(f"2. 후행 필터링   : 2010-2019년 & 평점 3.6이하만 추출")
